...
//const redpin= L.marker([48.866200610611926, 2.352236247419453], {icon: redPin}).addTo(myMap).bindPopup('Reaumur-Sebastopol')

// Metro station markers:
const rS = L.marker([48.866200610611926, 2.352236247419453], {icon: redPin}).bindPopup('Reaumur-Sebastopol')
